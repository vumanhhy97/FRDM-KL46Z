...
void task_test_lcd(void)
{
  ...
  if (!ti_task)
  {
    ...
    switch(count_mode)
    {
    case 0: vfnLCD_Write_Msg("   M");printf("\r\n LCD Test: %d", 0000);  break;
    case 1: vfnLCD_Write_Msg("  MA");printf("\r\n LCD Test: %d", 1111);  break;
    case 2: vfnLCD_Write_Msg(" MAN");printf("\r\n LCD Test: %d", 2222);  break;
    case 3: vfnLCD_Write_Msg("MANH");printf("\r\n LCD Test: %d", 3333);  break;
    case 4: vfnLCD_Write_Msg("ANH ");printf("\r\n LCD Test: %d", 4444);  break;
    case 5: vfnLCD_Write_Msg("NH  ");printf("\r\n LCD Test: %d", 5555);  break;
    case 6: vfnLCD_Write_Msg("H   ");printf("\r\n LCD Test: %d", 6666);  break;
    case 7: vfnLCD_Write_Msg("    ");printf("\r\n LCD Test: %d", 7777);  break;
    }
